...
<head>
    ...
    <title>Solicitud Tecnico Académico</title>
</head>
<body>
    <div class="container form-container">
        <h5 class="center-align">Solicitud Tecnico Académico</h5>


        <?php 
         include "../../../php/conexion_be.php";
         include "../../../php/registro_tecnico_academico.php";
        ?>
        ...
        <form method="POST" id="solicitud-form">
            ...
            <div class="row center">
              <button type="submit" class="waves-effect waves-light btn green darken-2" id="submit-btn" name="btnregistrar" value="ok">Enviar Solicitud</button>
